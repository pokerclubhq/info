---
title: Widgets
description: The Poker Club HQ widget gallery — the eleven built-in timer blocks, why a widget looks empty, and how to save, rename, and reuse your own.
---
...
<Image src={w00001} alt="The Widgets gallery, a two-column grid of live previews — Blinds and antes, Knockouts, Payouts and High hand showing real data, and Bounties showing a crossed-out eye with an info button" width={720} />

## Built-in widgets

Eleven widgets ship with the app. Most of them hide themselves until the tournament actually has something to show, so it's safe to add them at any point — a Payouts widget added before anyone has bought in simply stays invisible until money comes in.
