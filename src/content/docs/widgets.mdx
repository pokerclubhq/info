...
Every part of this is yours to change. Delete `!isPostgame` from the Timer block's condition and the clock stays up after the game; delete `isPostgame` from Points and it shows the standings as they build, moving numbers and all.
