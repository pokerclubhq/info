...
The default timer layout is built from these: a **Rebuy countdown**, a **Timer**, and a **High hand** in one column, a **Payouts**, a **Knockouts**, and a **Chip leader** in another. The Payouts *screen* layout is a **Payouts** beside a **Bounties**.
