---
title: Widgets
description: The Poker Club HQ widget gallery — the twelve built-in timer blocks, why a widget looks empty, and how to save, rename, and reuse your own.
---
...
Twelve widgets ship with the app. Most of them hide themselves until the tournament actually has something to show, so it's safe to add them at any point — a Payouts widget added before anyone has bought in simply stays invisible until money comes in.
...
| **Chip leaders** | The top three active players by stack, with their totals | A player has reported a chip count |
...
| **Timer** | The full default block — tournament title, level title and subtitle, the countdown clock, a **Color up!** banner, and the next three widgets nested inside it | Always |
...
The default timer layout is built from these: a **Rebuy countdown**, a **Timer**, and a **High hand** in one column, a **Payouts**, a **Knockouts**, and a **Chip leaders** in another. The Payouts *screen* layout is a **Payouts** beside a **Bounties**.
...
| **Chip leaders** | `chipLeaders.isNotEmpty` |
