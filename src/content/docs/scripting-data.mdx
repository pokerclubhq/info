...
description: Every value a Poker Club HQ script can read — timer state, level, player counts, money, payouts, high hand, chip leaders — plus what's inside a player, table, level, and log entry.
---
