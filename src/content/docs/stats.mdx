...
- **Script** — An EZScript expression that calculates a player's points. The built-in formula curves the award logarithmically by finishing place, and splits a tie across the places it spans the way payouts do. The simplest alternative, `totalPlayerCount - playerId.toPlayer().place + 1`, just pays one point per player you outlasted.
