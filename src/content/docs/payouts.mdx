...
:::note
Bounty chip purchases are **not** included in Total collected. The bounty pool is kept separate from the prize pool — bounties move directly between players when one knocks out another. See [Bounties](/info/bounties/) for details.
:::
